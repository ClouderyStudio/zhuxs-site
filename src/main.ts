...
app.use(VueLazyload, {
  loading: "https://a.cldery.com/d/oss/mcweb/assets/loading.gif",
  error: "https://a.cldery.com/d/oss/mcweb/assets/error.png",
});
app.use(head);
  ...
  metaInfo: {
    meta: [
      ...
      },
      {
        ...
        content:
          "这里是竹像素服务器官方网站，你可以在这里获取到关于竹像素的介绍以及服务器的运行信息。",
      },
