      ...
      <section v-lazy="'/assets/slimefun-base.png'"
        ...
        <div class="container">
          ...
          <div class="typo light section-1-text-1">
            ...
            <p>
              <strong>而这一切，都不是孤独的进程。</strong>我们相信，最好的生存服，是社区一起养成的。这一周是极简空岛，下一周或许就是群系大冒险——我们共同投票决定下个阶段的玩法方向，也会一起复盘哪些模组、插件或是数据包让夜晚过于冗长，哪些设定恰好成就了惊喜。管理员不是规则的执行者，是和你一起蹲在矿车里、仰头看烟花绽放的同行人。
            </p>
            <p>
